...
<head>
	<meta charset="utf-8">
	<title>{{ $title ?? 'PemWeb - Website Services' }}</title>
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=5">
	<meta name="description" content="{{ $description ?? 'Explore services offered by PemWeb' }}">
	<meta name="keywords" content="web development, PemWeb, Laravel, services, portfolio, digital agency">
	<meta name="author" content="PemWeb Team">
	...
	<!-- Open Graph -->
	<meta property="og:title" content="{{ $title ?? 'PemWeb - Website Services' }}">
	<meta property="og:description" content="{{ $description ?? 'Explore services offered by PemWeb' }}">
	...
	<meta name="twitter:image" content="{{ asset('front/images/og-image.jpg') }}">
